...
**Spec:** `~/Vau-Tailscale/VAU-AUDIT.md` (аудит от 2026-09-10, ревизия `d6a7411`). План реализует раздел «Что улучшить» этого отчёта; каждая находка C*/H*/M* ниже ссылается на него.
